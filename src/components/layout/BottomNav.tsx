...
export function BottomNav({ activeOrders = 0 }: { activeOrders?: number }) {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 mx-auto flex max-w-[430px] items-center justify-center gap-8 border-t-2 border-border bg-white px-screen pt-2 text-primary-foreground"
